  ...
  return (
    <section className="relative flex flex-col md:flex-row min-h-[calc(85vh)] pt-24 w-full bg-black overflow-hidden">
      ...
      <div className="flex flex-col justify-center px-6 md:px-16 lg:px-24  md:w-1/2 z-10">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-light leading-tight mb-6">
          Fulfill your dreams,<br />drive in style.
        </h1>
        <p className="text-light/50 text-lg mb-8 max-w-md">
          Hand-picked luxury and performance vehicles, backed by a team that
          treats every sale like it&apos;s their own car.
        </p>
        <div className="flex gap-4">
          <button className="bg-red-700 hover:bg-black cursor-pointer font-black text-light px-8 py-3 r transition-colors">
            Browse Inventory
          </button>
          <button className="border border-white/15 cursor-pointer hover:border-white text-light/50 hover:text-light px-8 py-3 transition-colors">
            See Gallery
          </button>
        </div>
